...
<body class="bg-slate-50 min-h-screen flex items-center justify-center p-6">
    ...
    <div class="bg-white w-full max-w-md p-8 rounded-2xl shadow-xl border border-slate-100">
        <div class="text-center mb-8">
            ...
            <p class="text-slate-500">Masuk untuk melihat kondisi dompetmu.</p>
        </div>
        ...
        <p class="text-center text-slate-500 mt-8 text-sm">
            Belum punya akun? <a href="{{ route('register') }}" class="text-indigo-600 font-bold hover:underline">Daftar dulu</a>
        </p>
    </div>
